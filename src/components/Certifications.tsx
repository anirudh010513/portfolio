          ...
          <Reveal key={cert.name} delay={index * 0.08} className="h-full">
            <Spotlight className="h-full">
              ...
              >
                ...
                <div>
                  <h3 className="font-display text-base font-semibold text-zinc-900 dark:text-white sm:text-lg">
                    {cert.name}
                  </h3>
